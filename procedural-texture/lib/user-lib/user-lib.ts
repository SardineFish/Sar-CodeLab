...
function vec2(x: number): Vector2
function vec2(x: number, y: number): Vector2
function vec2(x: number, y = x): Vector2
{
...
function vec3(x: number): Vector3
function vec3(x: number, y: number, z: number): Vector3
function vec3(x: number, y: number = x, z: number = x): Vector3
{
...
function vec4(x: number): Vector4
function vec4(x: number, y: number, z: number, w: number): Vector4
function vec4(x: number, y: number = x, z: number = x, w: number = x): Vector4
{
...
function plus<U extends vec, V extends vec>(a: U, b: V): ArithmeticType<U, V>
{
    const [lhs, rhs] = _arithOrder(a, b);
    return rhs.__to(lhs.constructor).plus(lhs);
}
function minus<U extends vec, V extends vec>(a: U, b: V): ArithmeticType<U, V>
{
...
function mul<U extends vec, V extends vec>(a: U, b: V): ArithmeticType<U, V>
{
    const [lhs, rhs] = _arithOrder(a, b);
    return rhs.__to(lhs.constructor).mul(lhs);
}
function div<U extends vec, V extends vec>(a: U, b: V): ArithmeticType<U, V>
{
    const [lhs, rhs, invert] = _arithOrder(a, b);
    return invert
